...
from func.plugins.common import getDriver, getheaders, SlowPrint
...
def TokenLogin(token):
    ...
    if type_ == "chromedriver.exe":
        ...
        print(f'{Fore.RESET}[{Fore.BLUE}Error{Fore.RESET}] : Couldn\'t find a suitable driver to automatically login to {user}')
        sleep(3)
