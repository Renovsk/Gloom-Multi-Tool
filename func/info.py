...
from func.plugins.common import getheaders
...
def Info(token):
    ...
    print(f'''
    {Fore.RESET}{Fore.WHITE}<<────────────{userName}────────────>>{Fore.RESET}
    [{Fore.BLUE}User ID{Fore.RESET}]         {userID}
    [{Fore.BLUE}Created at{Fore.RESET}]      {creation_date}
    [{Fore.BLUE}Language{Fore.RESET}]        {language}
    [{Fore.BLUE}Badges{Fore.RESET}]          {badges}
    [{Fore.BLUE}Avatar URL{Fore.RESET}]      {avatar_url if avatar_id else ""}
    [{Fore.BLUE}Token{Fore.RESET}]           {token}
    {Fore.RESET}{Fore.WHITE}<───────────Security Info───────────>{Fore.RESET}
    [{Fore.BLUE}2 Factor{Fore.RESET}]        {mfa}
    [{Fore.BLUE}Email{Fore.RESET}]           {email}
    [{Fore.BLUE}Phone number{Fore.RESET}]    {phone if phone else ""}
    {Fore.RESET}{Fore.WHITE}<────────────Nitro Info─────────────>{Fore.RESET}
    [{Fore.BLUE}Nitro Status{Fore.RESET}]    {has_nitro}
    [{Fore.BLUE}Expires in{Fore.RESET}]      {days_left if has_nitro else "0"} day(s)
                ''')
    if len(billing_info) > 0:
        print(f"\t\t{Fore.RESET}{Fore.WHITE}<────────────Billing Info────────────>{Fore.RESET}")
        if len(billing_info) == 1:
            for x in billing_info:
                for key, val in x.items():
                    if not val:
                        continue
                    print(f"[{Fore.BLUE}"+'{:<23}{:<10}{}'.format(key+Fore.RED+Fore.RESET+"]", Fore.RESET, val))
        else:
            for i, x in enumerate(billing_info):
                ...
                if i < len(billing_info) - 1:
                    print(f'{Fore.RESET}\n')
        print(f'{Fore.RESET}')
    input(f'{Fore.RESET}> {Fore.RESET}Enter anything to continue . . .  {Fore.BLUE}')
    Gloom.main()